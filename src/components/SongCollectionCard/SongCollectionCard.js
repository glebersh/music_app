...
import { getSongCollectionTracks, setIsPlayingTrue } from '../../store/slices/playerSlice';
...
const SongCollectionCard = (props) => {
  ...
  return (
    (<Flex m='1em 0 0 0' direction='column' align='center' justify='flex-start'
      ...
      <Link to={''}>
        <Text
          _hover={{ color: 'primary' }}>{props.collectionType === 'ALBUMS' ? props.artists[0].name : null}</Text></Link>
